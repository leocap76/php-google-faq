...
$googleFaq = [
  ...
  [
    "question" => "Come state implementando la recente decisione della Corte di giustizia dell'<a href='https://www.dafont.com/it/'>Unione europea</a> (CGUE) relativa al diritto all'oblio?",
